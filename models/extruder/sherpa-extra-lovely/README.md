...
![Sherpa Extra Lovely](extruder.png)
...
![Sherpa Extra Lovely - fully assembled](assembled.jpg)

If you're flying the extruder, you'll need to print the `flying-extruder-mount.stl`. I suggest using hair elastics and zip ties to secure the mount to the carriages.

![Sherpa Extra Lovely - flying extruder](flying-extruder.jpg)
...
If you prefer this approach, print the `45deg-tower-mount.stl` and the `mounting-plate.stl`.

![Sherpa Extra Lovely - tower mounted](bowden.jpg)
